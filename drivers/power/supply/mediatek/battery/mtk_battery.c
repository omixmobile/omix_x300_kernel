...
#if defined (CONFIG_MTK_CW2017_SUPPORT)
		if(cw2017_exit_flag == 1)
			val->intval = g_cw2017_bat_temperature_val;
#endif
...
#endif
//prize--huangjiwu---for ---modify--end
